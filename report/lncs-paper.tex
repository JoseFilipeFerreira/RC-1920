...
Tal como já foi supra referido, as frequências ocupadas pelo 4G estão
compreendidas num intervalo. Assim, cada país escolheu uma ou mais
frequências para serem utilizadas. Como solução para este problema
forma desenvolvidas antenas multi-banda que se conseguem ligar a
redes móveis por todo o mundo. Eventualmente estas antenas foram
miniaturizado e integradas em dispositivos móveis \cite{XinLi18}.
